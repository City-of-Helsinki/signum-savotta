...
# Local addition (vendored fork): print without feeding.
# Used by chain printing to avoid the trailing feed-and-cut so subsequent
# prints stay contiguous on the same tape strip.
