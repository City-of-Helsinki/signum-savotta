...
from sqlalchemy import SmallInteger, BigInteger, Text, String, JSON
...
class SierraItem(Base):
    ...
    barcode: Mapped[str] = mapped_column("barcode", String(1000))
    bib_number: Mapped[str] = mapped_column("bib_number", Text)
    bib_record_id: Mapped[int] = mapped_column("item_record_id", BigInteger)
    best_author: Mapped[str] = mapped_column("best_author", String(1000))
    best_title: Mapped[str] = mapped_column("best_title", String(1000))
    itype_code_num: Mapped[int] = mapped_column("itype_code_num", SmallInteger)
    item_type_name: Mapped[str] = mapped_column("item_type_name", String(255))
    material_code: Mapped[str] = mapped_column("material_code", String(3))
    material_name: Mapped[str] = mapped_column("material_name", String(255))
